...
const Home = () => {
  ...
  return (
    <div id="home-page" className="flex sm:flex-row flex-col w-screen flex-none top-0 border-x border-black text-4xl text-center pt-0 sm:pt-20">

      <div className="flex flex-col sm:w-[50%] w-full flex-nowrap border-r-2 border-black ">
        <div className={`${style}`}>
      ...
      <div className="flex flex-col sm:w-[25%] w-full border-r-2 border-black ">
        <div className={`${style}`}>
      ...
      <div className="flex flex-col sm:w-[25%] w-full">
        <div className={`${style}`}>
