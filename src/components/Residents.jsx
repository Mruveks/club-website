...
const Residents = () => {
  ...
  const cellStyle = "grid items-center h-96 bg-cover hover:opacity-60 hover:grayscale hover:text-white border-black"

  return (
    <table className="flex flex-none w-screen text-center bg-yellow-600 top-0 text-4xl pt-20">
